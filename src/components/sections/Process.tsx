      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          <ProcessStep 
            number={1}
            title="שלב הרעיון"
            description="פגישת התנעה להבנת החזון שלך וניתוח הצרכים - מה הבעיה שאנחנו פותרים ולמי?"
            icon={ideaIcon}
            delay={0.1}
          />
          ...
          <ProcessStep 
            number={2}
            title="אפיון קצר"
            description="הגדרת המאפיינים החיוניים לגרסת ה-MVP, תוך התמקדות במה שבאמת חשוב לגרסה הראשונית"
            icon={designIcon}
            delay={0.2}
          />
          ...
          <ProcessStep 
            number={4}
            title="השקה לחנויות"
            description="העלאת האפליקציה לחנויות האפליקציות, כולל הכנת חומרי שיווק ותמיכה בתהליך האישור"
            icon={launchIcon}
            delay={0.4}
          />
        </div>
